...
public interface LinkedConverterTreeInterface<T> {
	 ...
	 * @param result The data to be added at the position defined by the code.
	 ...
	 * @throws UnsupportedOperationException If the code has too many dashes or dots and the letter cannot be added.
	 */
	public void addNode(TreeNode<T> root, T code, T letter) throws UnsupportedOperationException;
